...
package cn.com.wanyueliang.exoplayer.videoControl;
...
import cn.com.wanyueliang.exolibrary.ui.animation.BottomViewHideShowAnimation;
import cn.com.wanyueliang.exolibrary.ui.animation.TopViewHideShowAnimation;
import cn.com.wanyueliang.exolibrary.ui.widget.VideoControls;
import cn.com.wanyueliang.exolibrary.ui.widget.VideoView;
import cn.com.wanyueliang.exolibrary.util.TimeFormatUtil;
import cn.com.wanyueliang.exoplayer.R;
...
public class SimpleVideoControl extends VideoControls {
    protected SeekBar seekBar;
    protected LinearLayout extraViewsContainer;

    protected boolean userInteracting = false;

    public SimpleVideoControl(Context context) {
        super(context);
    }

    public SimpleVideoControl(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SimpleVideoControl(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SimpleVideoControl(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
